...
# addTextElt("ZARAGOZA_AR_ES", 'trip')
# addTextElt("YOKOHAMA_KN_JP", 'trip')
# addTextElt("XINING_QH_CN", 'trip')
# addTextElt("XIAN_SA_CN", 'trip')
# addTextElt("TURKU_SF_FI", 'trip')
# addTextElt("TUNIS_TU_TN", 'trip')
# addTextElt("TRONDHEIM_TR_NO", 'trip')
# addTextElt("TBILISI_TB_GE", 'trip')
# addTextElt("STAVANGER_RO_NO", 'trip')
# addTextElt("SANTO_DOMINGO_ND_DO", 'trip')
# addTextElt("RIYADH_RI_SA", 'trip')
# addTextElt("PORT_AU_PRINCE_OU_HT", 'trip')
# addTextElt("PHUKET_PH_TH", 'trip')
# addTextElt("HO_CHI_MINH_CITY_SE_VN", 'trip')
# addTextElt("PALMA_BA_ES", 'trip')
# addTextElt("HERAKLION_CR_GR", 'trip')
# addTextElt("GEORGE_TOWN_PE_MY", 'trip')