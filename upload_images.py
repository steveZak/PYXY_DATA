...
# uploadImages("BAGHDAD_BA_IQ")
# uploadImages("CASABLANCA_CA_MA")
# uploadImages("CHISINAU_CH_MD")
# uploadImages("CORK_CO_IE")
# uploadImages("GALWAY_GA_IE")
# uploadImages("HAKONE_KN_JP")
# uploadImages("HYDERABAD_AP_IN")
# uploadImages("INCHEON_SE_KR")
# uploadImages("LIMERICK_LI_IE")
# uploadImages("MECCA_MA_SA")
# uploadImages("MEDINA_AM_SA")
# uploadImages("MERIDA_YU_MX")
# uploadImages("PYONGYANG_PY_KP")
